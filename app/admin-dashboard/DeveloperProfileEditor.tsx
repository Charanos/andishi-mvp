...
const DeveloperProfileEditor: React.FC<Props> = ({ profileId }) => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        console.log("Fetching profile from /api/developer-profiles...");
  ...
  const renderStats = () => (
    <section className="bg-white/5 p-6 rounded-lg">
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-r from-green-500/20 to-teal-500/20 p-4 rounded-lg text-center">
        ...
        <div className="bg-gradient-to-r from-pink-500/20 to-red-500/20 p-4 rounded-lg text-center">
  ...
  return (
    <div className="min-h-screen bg-gray-200/5 backdrop-blur-none">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              ...
              <p className="text-gray-300">
                Manage your professional developer profile and showcase your
                skills
              </p>
            </div>
            <div className="flex gap-3">
              <button
                onClick={handleSave}
                disabled={saving}
                className="bg-green-500 hover:bg-green-600 disabled:bg-green-500/50 text-white px-6 py-2 rounded-lg flex items-center gap-2 transition-colors"
              >
