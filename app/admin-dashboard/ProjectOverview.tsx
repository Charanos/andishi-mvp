...
const ProjectOverview: React.FC<ProjectOverviewProps> = ({
  ...
  return (
    <>
      {/* Mobile hamburger */}
      <button
        className="lg:hidden fixed top-60 right-6 z-50 p-3 bg-indigo-600/90 rounded-lg backdrop-blur-md border border-white/20"
      ...
      {sidebarOpen && (
        <>
          <div
            className="fixed inset-0 bg-black/10 backdrop-blur-xl z-40 min-w-screen h-screen"
            onClick={() => setSidebarOpen(false)}
          />
          <div className="fixed top-0 left-0 z-50 h-full max-w-full transform transition-transform duration-300 ">
            <ProjectSidebar
            ...
            {trackingView === "activity" && (
              <div className="">
                ...
                <p className="text-gray-400 text-sm mb-6">
                  All project activities including updates, milestones,
                  payments, file uploads, chat messages, and assignments.
                </p>
