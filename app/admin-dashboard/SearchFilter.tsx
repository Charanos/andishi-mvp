      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
        <div className="flex-1 max-w-md">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-black/40 border border-slate-600/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          <select
            ...
            className="px-4 py-3 bg-black/40 border border-slate-600/50 rounded-xl text-white focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all cursor-pointer"
          >
            <option value="all" className="bg-black/40">
              All Status
            </option>
            <option value="pending" className="bg-black/40">
              Pending
            </option>
            <option value="reviewed" className="bg-black/40">
              Reviewed
            </option>
            <option value="approved" className="bg-black/40">
              Approved
            </option>
            <option value="rejected" className="bg-black/40">
              Rejected
            </option>
          </select>
          ...
          >
            ...
            <option value="critical" className="bg-black/40">
              Critical
            </option>
            <option value="high" className="bg-black/40">
              High
            </option>
            <option value="medium" className="bg-black/40">
              Medium
            </option>
            <option value="low" className="bg-black/40">
              Low
            </option>
          </select>
        </div>
