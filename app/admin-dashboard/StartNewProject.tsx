...
export default function StartProjectForm({
  ...
  const steps = [
    { number: 1, title: "Client Info", icon: FaUser },
          ...
          <div className="mb-12 flex items-center justify-between w-full">
            {dashboardMode && (
              <button
                type="button"
                onClick={onCancel}
                className="mb-6 bg-white/5 hover:bg-white/10 px-4 py-2 rounded-lg cursor-pointer monty uppercase flex items-center text-sm text-gray-400 hover:text-white transition-colors"
              >
                <FaArrowCircleLeft className="mr-2 " /> Back to Projects
              </button>
            )}

            <div className="text-right">
              <h1 className="text-2xl lg:text-3xl font-medium text-white mb-4">
                Create <span className="text-purple-400">Client Project</span>
              </h1>
              <p className="text-md text-gray-300 max-w-2xl mx-auto">
                Enter client project details to set up a new engagement and
                assign the appropriate development resources.
              </p>
            </div>
          </div>
