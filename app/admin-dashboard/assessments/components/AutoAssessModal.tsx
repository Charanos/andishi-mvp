...
import { X, Upload, FileText, Zap, User, Loader2, CheckCircle } from 'lucide-react';
...
export default function AutoAssessModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-gray-900/95 backdrop-blur-xl border border-white/10 rounded-2xl w-full max-w-2xl shadow-2xl">
        {/* Header */}
