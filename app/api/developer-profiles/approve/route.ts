...
export async function PATCH(req: NextRequest) {
    try {
        ...
        // First, get the developer profile using Prisma
        ...
        // Update developer profile status and availability using Prisma
        ...
        // Update associated user status using Prisma
        ...
        if (developerProfile.userId) {
            ...
            try {
                ...
                console.error(`Failed to update user ${developerProfile.userId}:`, userError);
            }
        } else {
