    ...
    >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="bg-green-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-green-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Our services are designed for businesses seeking high-quality
              software development, staff augmentation, and technology
      ...
      >
        ...
        <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-blue-50 dark:bg-black/30 p-4 rounded-lg border border-blue-500/20">
            ...
            <div className="bg-purple-50 dark:bg-black/30 p-4 rounded-lg border border-purple-500/20">
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="bg-orange-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-orange-400">
            <h3 className="font-semibold text-orange-600 dark:text-orange-400 mb-2">
              Client Responsibilities
            </h3>
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Timely feedback, resource access, and clear communication are
              essential for project success. Delays in client deliverables may
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="bg-green-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-green-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Standard payment terms are Net 14 days. Late payments may incur
              interest charges or temporary service suspension until account is
              brought current.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            ...
            contract is transferred to the client upon full payment of all dues.
            Prior assets (e.g., templates, libraries) remain property of Andishi
            MVP unless licensed otherwise.
          </p>
          <div className="bg-purple-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-purple-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Custom code and designs created specifically for your project
              transfer to you upon full payment. Pre-existing tools and
              frameworks remain our property.
            </p>
          </div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            ...
            contractual obligations. Confidentiality survives the contract term.
          </p>
          <div className="bg-blue-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-blue-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              ...
              are treated with strict confidentiality and protected according to
              industry standards.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            Andishi MVP's total liability shall not exceed the fees paid for the
            relevant project. We are not liable for indirect or consequential
            damages unless explicitly agreed.
          </p>
          <div className="bg-red-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-red-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Our maximum liability is capped at the project value. We disclaim
              liability for lost profits, business interruption, or
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="bg-yellow-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-yellow-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Standard termination requires 14 days notice. Immediate
              termination for breach requires 7-day cure period. Work completed
              to termination date will be invoiced.
            </p>
          </div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            This agreement shall be governed by the laws of Kenya. Any disputes
            will be handled in the courts of Nairobi, unless otherwise agreed in
            writing.
          </p>
          <div className="bg-blue-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-blue-400">
            <h3 className="font-semibold text-blue-600 dark:text-blue-400 mb-2">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              All legal matters are subject to Kenyan law and the jurisdiction
              of Nairobi courts. Alternative dispute resolution may be
              considered by mutual agreement.
            </p>
          </div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            If you have any questions or requests regarding these terms, please
            reach us at:
          </p>
          <div className="bg-green-50 dark:bg-black/30 p-4 rounded-lg border border-green-500/20">
            ...
            <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
              <p>
                <strong>Company:</strong> Andishi MVP
              </p>
              <p>
