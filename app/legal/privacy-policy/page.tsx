...
const PrivacyPolicyPage = () => {
  return (
    <LegalPageLayout title="Privacy Policy" lastUpdated="July 14, 2025">
      <motion.section
      ...
      >
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-6 flex items-center">
          <span className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-primary dark:to-purple text-transparent bg-clip-text">
            1.
          </span>
          <span className="ml-3">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            Andishi is committed to protecting your personal data in strict
            compliance with the Data Protection Act, 2019 and its implementing
            regulations under Legal Notice 263/2021.
          </p>
          <div className="bg-blue-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-blue-400">
            ...
            <div className="space-y-1 text-sm text-gray-700 dark:text-gray-300">
              ...
              <p>
                <strong>Address:</strong> Ruiru, Kiambu County, Kenya
              </p>
              <p>
                <strong>ODPC Registration:</strong> In compliance with Section
                25
              </p>
            </div>
          </div>
      ...
      >
        ...
        <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            We collect only necessary personal data, in strict adherence to the
            principles of data minimisation and purpose limitation as outlined
            in Section 26 of the Data Protection Act, 2019.
          </p>
          ...
          <div className="bg-yellow-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-yellow-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Where personal data is obtained indirectly, we will notify you
              within 14 days as required by Regulation 4 of LN 263/2021.
            </p>
          </div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            All personal data processing is conducted based on lawful grounds as
            specified in Section 30 of the Data Protection Act, 2019.
          </p>
          ...
          <div className="grid gap-4">
            <div className="bg-blue-50 dark:bg-black/30 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Processing necessary for contract performance with developers
                and clients, including project matching and payment processing.
              </p>
            </div>

            <div className="bg-green-50 dark:bg-black/30 dark:to-teal-900/30 p-4 rounded-lg">
              <h3 className="font-semibold text-green-600 dark:text-green-400 mb-2">
                Legitimate Business Interests
              </h3>
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Platform security, fraud prevention, service improvement, and
                business analytics (balanced against your rights).
              </p>
            </div>

            <div className="bg-purple-50 dark:bg-black/30 dark:to-pink-900/30 p-4 rounded-lg">
              <h3 className="font-semibold text-purple-600 dark:text-purple-400 mb-2">
                Consent
              </h3>
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Where explicitly required, such as for marketing communications
            ...
            <div className="bg-red-50 dark:bg-black/30 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300">
                Processing required to comply with legal obligations under
                Kenyan law.
              </p>
            </div>
          </div>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            We may share your data only under legally permitted circumstances as
            outlined in Section 35 and Regulation 21 of LN 263/2021.
          </p>
          ...
          <div className="bg-purple-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-purple-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              All data sharing requires written agreements specifying purpose,
              retention period, and safeguards in compliance with Regulation 21
              of LN 263/2021.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            ...
            stated purposes, in accordance with our Data Retention Schedule.
          </p>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-orange-50 dark:bg-black/30 p-4 rounded-lg">
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            In accordance with the Data Protection Act, 2019, you have the
            following rights:
          </p>
          ...
          <div className="bg-green-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-green-400">
            <h3 className="font-semibold text-green-600 dark:text-green-400 mb-2">
              How to Exercise Your Rights
            </h3>
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Submit requests to our Data Protection Officer through the contact
              details below. We respond promptly within statutory timeframes,
              free of charge.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            If we use automated profiling or decision-making that significantly
            affects you, we will inform you of the logic involved and provide
          ...
          <div className="bg-yellow-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-yellow-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              You have the right to human intervention, express your point of
              view, and contest automated decisions under the Data Protection
              Act.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
          <p>
            ...
            Commissioner (ODPC) and maintain high standards of data protection
            compliance.
          </p>
          <div className="bg-red-50 dark:bg-black/30 p-4 rounded-lg border-l-4 border-red-400">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              ...
              through our internal complaints process. We are committed to
