...
export default function NewsletterSection() {
  ...
  if (isSubscribed) {
    return (
      <section
        id="newsletter"
        className="py-32 relative bg-gray-50 dark:bg-transparent"
      >
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="backdrop-blur-md bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-12 shadow-lg dark:shadow-none">
  ...
  return (
    <section
      id="newsletter"
      className="py-16 mt-16 relative bg-gray-50 dark:bg-transparent"
    >
      <div className="relative z-10 max-w-4xl mx-auto px-6">
        <div className="relative overflow-hidden backdrop-blur-md bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl p-8 lg:p-12 text-center shadow-lg dark:shadow-none">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-gray-100 dark:bg-white/10 border border-gray-300 dark:border-white/20 rounded-full text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:border-blue-500 dark:focus:border-blue-400 focus:bg-gray-50 dark:focus:bg-white/15 transition-all duration-300"
                  />
                </div>
