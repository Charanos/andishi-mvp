...
export default function TechTalentPool() {
  ...
  const developers: Developer[] = [
    ...
    },
    {
      ...
      bio: "Dedicated mobile developer crafting engaging, high-performance apps across iOS and Android.",
      about:
        "I'm a mobile developer with over 6 years of experience building innovative mobile applications for startups and enterprises. I specialize in developing both cross-platform and native apps, focusing on seamless user experiences, performance tuning, and clean architecture. My passion is translating user needs into polished, reliable mobile solutions.",
      languages: [
        "English (Native)",
        "Korean (Fluent)",
      ...
      projectHighlights: [
        {
          ...
          description:
            "Led development of a cross-platform delivery app with real-time tracking, in-app payments, and push notifications.",
          tech: ["Flutter", "Firebase", "Google Maps API", "Stripe SDK"],
          duration: "9 months",
        },
        {
          title: "Health & Fitness Tracker",
          description:
            "Built native iOS and Android apps for activity tracking, wearable integration, and data visualization.",
          tech: ["Swift", "Kotlin", "Realm DB", "HealthKit", "Google Fit"],
          duration: "7 months",
        },
        {
          title: "Social Networking App",
          description:
            "Developed a social networking mobile app featuring live chat, media sharing, and scalable backend integration.",
          tech: ["React Native", "GraphQL", "AWS AppSync", "Redux"],
          duration: "6 months",
        },
      ],
      testimonials: [
        {
          client: "QuickDeliver",
          feedback:
            "David delivered a polished delivery app that significantly improved our customer satisfaction and retention.",
          project: "On-Demand Delivery App",
          rating: 5.0,
        },
        {
          client: "FitLife",
          feedback:
            "The fitness tracker apps were smooth and intuitive. David’s attention to detail in UX was exceptional.",
      ...
      workHistory: [
        {
          company: "TechMob Studios",
          position: "Senior Mobile Developer",
          duration: "2021 - Present",
          description:
            "Architect and implement mobile solutions across iOS and Android, mentor junior devs, and optimize app performance.",
        },
        {
          company: "SocialApps Inc",
          position: "Mobile Developer",
          duration: "2019 - 2021",
          description:
            "Developed social media mobile experiences, focusing on real-time features and multimedia handling.",
        },
        {
          company: "Local Startup",
          ...
          duration: "2018 - 2019",
          description:
            "Supported development of mobile MVPs, conducted user testing, and iterated based on feedback for early-stage products.",
        },
      ],
    },
    {
      ...
      bio: "Versatile fullstack developer delivering end-to-end web solutions with clean, scalable code.",
      about:
        "I'm a fullstack developer with over 5 years of experience building robust, scalable applications for startups, enterprises, and NGOs. I excel in crafting seamless user experiences with React on the frontend and designing maintainable server-side architectures with Node.js and Express. Passionate about clean code, performance optimization, and reliable deployments using Docker and CI/CD pipelines.",
      languages: ["English (Fluent)", "Swahili (Native)", "French (Basic)"],
      education:
        "MAC(Mathematics and Computer Science) in Kenya Methodist University (KEMU)",
      certifications: [
      ...
      projectHighlights: [
        {
          ...
          description:
            "Built a full-featured e-commerce application with product management, shopping cart, and payment integrations.",
        ...
        },
        {
          ...
          description:
            "Developed a real-time document collaboration app using WebSockets for live updates and multi-user editing.",
          tech: ["TypeScript", "Socket.io", "React", "Node.js"],
          duration: "6 months",
        },
        {
          title: "SaaS Analytics Dashboard",
          description:
            "Implemented a multi-tenant analytics dashboard with data visualization, reporting, and role-based access.",
      ...
      testimonials: [
        {
          client: "ShopEase",
          feedback:
            "Eric delivered a robust e-commerce solution that scaled with our user base. His architectural insights were invaluable.",
          project: "E-Commerce Platform",
          rating: 4.9,
        },
        {
          client: "CollabWorks",
          feedback:
            "The real-time collaboration tool exceeded performance expectations. Eric’s code quality and communication were top-notch.",
      ...
      workHistory: [
        {
          ...
          duration: "2022 - Present",
          description:
            "Architect and implement end-to-end web applications for global clients, mentor junior developers, and drive best practices in CI/CD and testing.",
        },
        {
          ...
          duration: "2020 - 2022",
          description:
            "Built scalable web solutions for NGOs and government projects, focusing on user-centric design and secure REST APIs.",
        },
        {
          company: "Freelance",
          ...
          duration: "2018 - 2020",
          description:
            "Delivered custom web applications for local SMEs, specializing in MVP development and rapid prototyping.",
        },
      ],
    },
  ];
  ...
  return (
    ...
    >
      <div className="absolute inset-0 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-indigo-900/20" />
      <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            {roles.map((role, index) => (
              <motion.button
                ...
                className={`px-6 py-2 rounded-full backdrop-blur-md border transition-all duration-300 cursor-pointer ${
                  selectedRole === role
                    ? "bg-purple-500/20 border-purple-400/50 text-gray-700 dark:text-gray-300"
                    : "bg-white/80 dark:bg-white/5 border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-400 hover:bg-white dark:hover:bg-white/10 hover:border-gray-300 dark:hover:border-white/20 hover:text-gray-900 dark:hover:text-gray-300"
                }`}
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {filteredDevelopers.map((developer: Developer) => (
              <motion.article
                key={developer.id}
                className="group relative overflow-hidden rounded-2xl backdrop-blur-md bg-white/90 dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:border-gray-300 dark:hover:border-white/20 transition-all duration-500 cursor-pointer"
              ...
              >
                ...
                <div className="relative h-48 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent dark:from-black/50 dark:to-transparent"></div>
                </div>
                ...
                <div className="p-6 relative z-10">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {developer.skills.slice(0, 3).map((skill, index) => (
                      <motion.span
                        key={skill}
                        className="px-3 py-1 text-xs font-medium rounded-full bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-300 border border-purple-200 dark:border-purple-500/30"
                        variants={badgeVariants}
                        initial="initial"
                        animate="animate"
                    ...
                    {developer.skills.length > 3 && (
                      <motion.span
                        className="px-3 py-1 text-xs font-medium rounded-full bg-gray-100 dark:bg-gray-500/20 text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-500/30"
                        variants={badgeVariants}
                        initial="initial"
                        animate="animate"
                  ...
                  <div className="flex justify-center">
                    <motion.button
                      ...
                      className="px-4 py-2 bg-blue-100 dark:bg-blue-500/20 hover:bg-purple-100 dark:hover:bg-purple-500/30 text-blue-700 dark:text-gray-300 text-sm font-medium rounded-full border border-blue-200 dark:border-purple-500/30 hover:border-purple-300 dark:hover:border-purple-400/50 transition-all duration-300 cursor-pointer"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      View Profile
        ...
        >
          <button
            className="p-2 rounded-lg bg-white/90 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/10 hover:text-gray-800 dark:hover:text-gray-300 transition-all duration-300"
            ...
            {[1, 2, 3, 4, 5].map((page) => (
              <button
                ...
                className={`px-4 cursor-pointer monty py-2 rounded-lg text-sm font-medium transition-all duration-300
                  ${
                    page === 1
                      ? "bg-blue-100 dark:bg-blue-500/20 border border-blue-200 dark:border-blue-400/50 text-blue-700 dark:text-gray-300"
                      : "bg-white/90 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-white/10 hover:text-gray-800 dark:hover:text-gray-300"
                  }`}
              >
                {page}
              </button>
