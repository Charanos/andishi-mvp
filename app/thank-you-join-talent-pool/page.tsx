...
export default function DeveloperThankYouPage() {
  ...
  return (
    <section className="min-h-screen py-32 relative overflow-hidden bg-gray-50 dark:bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-3xl lg:text-4xl font-semibold text-gray-900 dark:text-white mb-6">
        ...
        {/* What Happens Next */}
        <div className="backdrop-blur-md bg-white/90 dark:bg-black/10 border border-gray-200 dark:border-white/10 rounded-2xl p-8 shadow-xl mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-8 text-center flex items-center justify-center">
            <FaLaptopCode className="mr-3 text-blue-600 dark:text-blue-400" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {nextSteps.map((step, index) => (
              <div
                key={index}
                className="p-6 rounded-xl border transition-all duration-300 hover:scale-105 bg-white dark:bg-white/5 border-gray-300 dark:border-white/10 hover:border-gray-400 dark:hover:border-white/20"
              >
        ...
        <div className="backdrop-blur-md bg-white/90 dark:bg-black/10 border border-gray-200 dark:border-white/10 rounded-2xl p-8 shadow-xl mb-12">
          <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-8 text-center flex items-center justify-center">
            <FaHandshake className="mr-3 text-green-600 dark:text-green-400" />
            What You Get as Part of Our Talent Pool
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-blue-100/50 to-cyan-100/50 dark:from-blue-500/10 dark:to-cyan-500/10 border border-blue-300 dark:border-blue-500/20">
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-purple-100/50 to-pink-100/50 dark:from-purple-500/10 dark:to-pink-500/10 border border-purple-300 dark:border-purple-500/20">
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-green-100/50 to-emerald-100/50 dark:from-green-500/10 dark:to-emerald-500/10 border border-green-300 dark:border-green-500/20">
        ...
        {/* Contact Information */}
        <div className="text-center p-6 backdrop-blur-md bg-white/90 dark:bg-black/10 border border-gray-200 dark:border-white/10 rounded-xl">
      ...
      <div
        className="absolute bottom-20 right-10 w-40 h-40 bg-purple-200/30 dark:bg-purple-500/8 rounded-full blur-3xl animate-pulse"
      ...
      ></div>
      <div
        className="absolute top-1/3 right-1/4 w-28 h-28 bg-pink-200/30 dark:bg-pink-500/8 rounded-full blur-3xl animate-pulse"
